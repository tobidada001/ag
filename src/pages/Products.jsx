...
const Products = () => {
  ...
  return (
    ...
    <ul className="flex space-x-5 justify-center font-[sans-serif]">
      ...
      <li
        className="flex items-center justify-center shrink-0 bg-green-500  border hover:border-green-500 border-green-500 cursor-pointer text-base font-bold text-white px-[13px] h-9 rounded-md">
        1
      </li>
      <li
        className="flex items-center justify-center shrink-0 border hover:border-green-500 cursor-pointer text-base font-bold text-gray-800 px-[13px] h-9 rounded-md">
        2
      </li>
      <li
        className="flex items-center justify-center shrink-0 border hover:border-green-500 cursor-pointer text-base font-bold text-gray-800 px-[13px] h-9 rounded-md">
