...
const TopBar = () => (
 <header class='shadow-lg font-[sans-serif] tracking-wide relative z-50'>
      <section
        ...
        <Link to={'/'} class="shrink-0 max-sm:hidden font-extrabold">
          Agripath ltd
        </Link>
        ...
        <div class='flex flex-wrap w-full items-center'>
          <input type='text' placeholder='Find crop...'
            class='xl:w-80 max-lg:hidden lg:ml-10 max-md:mt-4 max-lg:ml-4 bg-gray-100  focus:bg-transparent px-4  rounded h-10  text-sm transition-all  border-green-600 focus:!outline-none focus:!ring-0' />
          <div class="ml-auto">
            ...
            <ul class='flex items-center'>
              ...
              <li class='flex text-[15px] max-lg:py-2 px-4 hover:text-[#007bff] hover:fill-[#007bff]'>
                <Link to={'/login'}
                  class='px-4 py-2 text-sm font-semibold text-gray-800 border border-[#333] bg-transparent'>Login</Link>
              </li>
